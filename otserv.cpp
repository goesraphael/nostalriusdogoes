...
void mainLoader(int, char*[], ServiceManager* services)
{
	...
	//set RSA key
	const char* p("13178155946762421296207228973505672415082874305065509293286736661127324650370439313078443964800482697101933117935450252474541389809538805203882970773366917");
	const char* q("7765434163084175123041718811029648538780087333146896358211157657180889596375733333802210637162357226796942341569841917022163592768780665453958500062992291");
	g_RSA.setKey(p, q);
